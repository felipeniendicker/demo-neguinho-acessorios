  ...
  return (
    <div className="page-stack">
      ...
      <Panel
        ...
        description="Reposicao sugerida, margem por peca e movimentacao rapida."
          ...
          columns={[
            ...
            { key: "actions", label: "Acoes", render: (row) => (
              <div className="row-actions">
                ...
                <button type="button" className="secondary-button" onClick={() => setForm({ ...row, quantity: String(row.quantity), minStock: String(row.minStock), costPrice: String(row.costPrice), salePrice: String(row.salePrice) })}>Editar</button>
